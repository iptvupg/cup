export const SITE = {
  ...
  secondaryKeywords: [
    ...
    'FIFA+ live football alternative',
    'FIFA 2026 stream',
    'IPTV World Cup streaming',
...
export const FAQS = [
  ...
  },
  {
    ...
    a: 'The FIFA World Cup 2026 begins on June 11, 2026 with the opening match at Estadio Azteca in Mexico City and ends with the final on July 19, 2026 at MetLife Stadium in East Rutherford, New Jersey.',
  },
  {
...
export const DEVICES = [
  ...
  { name: 'Roku', icon: 'roku' },
  { name: 'Amazon Fire TV', icon: 'firetv' },
  { name: 'Chromecast', icon: 'chromecast' },
  { name: 'Samsung Smart TV', icon: 'samsung' },
  { name: 'LG Smart TV', icon: 'lg' },
  { name: 'Vizio SmartCast', icon: 'vizio' },
  { name: 'iPhone & iPad', icon: 'apple-mobile' },
  { name: 'Android', icon: 'android' },
  { name: 'Xbox Series X|S', icon: 'xbox' },
  { name: 'PlayStation 5', icon: 'playstation' },
  { name: 'Web browser', icon: 'browser' },
];
...
export const MATCH_PHASES = [
  { phase: 'Group Stage', dates: 'Jun 11 – Jun 27', matches: 72 },
  { phase: 'Round of 32', dates: 'Jun 28 – Jul 3', matches: 16 },
  { phase: 'Round of 16', dates: 'Jul 4 – Jul 7', matches: 8 },
